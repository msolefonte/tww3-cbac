...
option_cbac_limit_rank:set_text("Dynamic Limit increase every N levels");
option_cbac_limit_rank:set_tooltip_text("Every x levels gained, a lord's army's limit will go up.");
...
option_cbac_army_limit_fl_bonus:set_text("Extra points for Faction Leader");
option_cbac_army_limit_fl_bonus:set_tooltip_text("How many extra points should have the faction leader?");
option_cbac_army_limit_fl_bonus:slider_set_min_max(0, 10000);
